...
import HeaderImg from '../assets/img/home/banner.png';
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-md-6 col-lg-5">
                                <h1 className="banner-heading">Cloud phone
                                    system for startups
                                    and growing team </h1>
                                <p className="banner-text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                                    accusantium doloremque laudantium, totam rem aperiam,
                                    eaque ipsa quae ab illo inventore veritatis</p>
                                <div className=" d-flex mt-5">
                                    <a href="#" className="btn btn-success small px-4 mr-3">Try it Free</a>
                                    <a href="javascript:;" className="btn small d-flex align-items-center text-primary modal-open" modal-data="videoplay">
                                        <img src={PlayIcon} alt="play" className="mr-2" /> Watch a Demo Video
                                    </a>
                                </div>
                            </div>
                        </div>
